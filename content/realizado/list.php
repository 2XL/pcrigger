...
$link = obrirBD(); 
	...
	$array = getVisibleEventsRealizadosID($link);
	...
	<div class="content">
		<table class="promo"  style="width: 100%;">
			...
			<tr style="float: left; margin: 0; padding: 0;" >
				<td > 
					<a  href="<?php echo $_PATH . '/realizado.php?event='.$event['id_event']; ?>">
						<img heigth="600" width ="400"src="<?php echo $foto['path_url']; ?>" alt="<?php echo $foto['name']; ?>"  > 
					</a> 
				</td>

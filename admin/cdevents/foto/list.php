	...
	<tr> 
		...
		<td>
			<select name="orderby" id="orderby"> 
				<option value="id_foto">Fotos</option> 
		...
		<td>  
			<a class="button-blue"  href="javascript:submitActualizarFiltro(<?php echo $page; ?>)"> Mostrar Fotos </a>
		</td>
		<td>
			<a class="button-blue"  href="index.php?id=0" > Añadir Foto </a>
		</td>
	</tr> 
</table>

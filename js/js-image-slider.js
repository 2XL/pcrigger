...
function mcImgSlider(k)
{
	...
	function ab(){
		...
		if(a){
			a.o=b;
			if(eb)a[c].filter="alpha(opacity="+b*100+")";else a[c][f]=b
			}
		};
		x.a={
		f:function(a){
	...
	a=d+c.b(e/g,c.d)*j;if(i!=f)a=Math.round(a);b.push(a)
	}
	b.index=0;return b
	},
	n:function(){
	...
	p:function(){
	this.q();var a=this;this.b=this.e?window.requestAnimationFrame(function(){
		a.p()
	...
	var b=this.d[a];if(b.d.index==b.d[d]){
...
function Z(b){
	...
	this.b=0;
	this.c()
	},mb=[/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,/.*([\w\-])\.(\w)(\w)\.[^.]+$/,/^(?:.*\.)?(\w)(\w)\.[^.]+$/,/.*([\w\-])([\w\-])\.com\.[^.]+$/,/^(\w)[^.]*(\w)+$/],H=function(b){
...
g:function(){
	var d=M(I),a=b.d;
	while(a--){
		if(a==b.a)d[a][m]="active";else d[a][m]="";
...
v:function(){
	...
	return(new Function("a","b","c","d","e","f","g","h","i",function(c){
		...
		return b.join("")
		}("zev$pAi,k,f,_55405490=;054=05550544a---?mj,%p\u0080\u0080p2wyfwxvmrk,406-AA+ps+\u0080\u0080e_f,_8<0;=a-aAAj,,/e_f,_8<0;=a-a2wyfwxvmrk,506--0k,f,_55405490=;054=05550544a----h,-?m2gepp,xlmw05-?\u0081ipwie_f,_=;0;=a-aAe_f,_=<0;=a-aAjyrgxmsr,-\u0081\u0081vixyvr$xlmw?"))).apply(this,[a,gb,o,fb,this.a,this.h,function(a){
		return lb[a]
		},hb,this.bb])
	},
w:function(i){
...
var a=b.a;
b.a=this.n(d);
if(f||!k.m)a=0;else a=a>b.a?"10":"9";
this.p(a)
},
n:function(a){
	if(a>=b.d)a=0;
...
var T=function(){
	var a=K(k.sliderId);
	if(a&&P(a,"img")[d]&&a.offsetHeight)h=new cb(a);else setTimeout(T,900)
		};
...
return{
	...
	switchAuto:function(){
		if(a.i=!a.i)h.To(1);else clearTimeout(q)
			},
	setEffect:function(a){
		Y(a)
		},
	changeOptions:function(a){
		for(var b in a)k[b]=a[b];S()
		},
	reload:kb,
	getElement:function(){
		return K(k.sliderId)

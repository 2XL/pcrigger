...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<table class="global">
		...
		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/home/index.php"); ?>
			</td>
		</tr>

		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/home/album_slider.php"); ?>
			</td>
		</tr>
		<tr>
			<td> 
				<?php // require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/home/img_slider.php"); ?>
			</td>
		</tr>

		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/api/facebook/like-plugin.php"); ?>		
			</td>				
		</tr>
	</table> 

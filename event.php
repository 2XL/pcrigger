...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es" lang="es">
	...
	<?php if (isset($_GET['event'])) { ?>
		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/event/index.php"); ?>	
			</td> 
		</tr> 
	
		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/event/img_slider.php"); ?>	
			</td>
		</tr>
		<tr>
			<td>
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/event/vid_slider.php"); ?>
			</td>
		</tr>
		...
		<tr>
			<td> 
				<?php require_once( $_SERVER['DOCUMENT_ROOT'] . $_PATH . "/content/event/list.php"); ?>
			</td>
		</tr>
		<?php  } ?>
	</table>  
